...
export const metadata: Metadata = {
  ...
  title: { default: 'TrustShield Insurance', template: `%s | TrustShield Insurance` },
  description: 'Comprehensive insurance solutions designed to protect your family, home, and business with personalized coverage.',
